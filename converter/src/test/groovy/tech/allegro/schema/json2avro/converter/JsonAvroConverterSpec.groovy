...
class JsonAvroConverterSpec extends Specification {
    ...
    def converter = new JsonAvroConverter(new ObjectMapper(), new LogOnUnknownProperty())
    def converterFailOnUnknown = new JsonAvroConverter(new ObjectMapper(), new FailOnUnknownProperty())
