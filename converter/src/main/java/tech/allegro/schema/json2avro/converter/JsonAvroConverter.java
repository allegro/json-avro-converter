...
public class JsonAvroConverter {
    ...
    public JsonAvroConverter(ObjectMapper objectMapper, UnknownPropertyListener unknownPropertyListener) {
        this.recordReader = new JsonGenericRecordReader(objectMapper, unknownPropertyListener);
    }
